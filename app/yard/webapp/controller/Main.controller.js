...
], function (Controller, JSONModel, Device, MessageToast, Filter, FilterOperator, Fragment, DateFormat) {
    "use strict";
    ...
    return Controller.extend("com.app.yard.controller.Main", {
        ...
        onUserDetailsLoad: function (oEvent) {
            ...
            if (this.ID === "Security") {
                ...
                oView.byId("flexBoxPage8").setVisible(false)
                oView.byId("idNotification").setVisible(false)
                // oView.byId("flexBoxPage8").setVisible(false)
                ...
                this.getView().byId("flexBoxPage8").setVisible(!isSecurity);
                this.getView().byId("idPage8").setVisible(isSecurity);
                //.getView().byId("idNotification").setVisible(isSecurity)
                this.getView().byId("flexBoxPageVendor").setVisible(isSecurity)
                oView.byId("vendor1").setVisible(false)
                oView.byId("vendor2").setVisible(false)
                oView.byId("vendor3").setVisible(false)
        ...
        onAssignPress: async function () {
            ...
            // var vehicalNoRegex=/^[A-Z]{2}[0-9]{2[A-Z]{2}[0-9]{4}$/;
            // if (!(vehicalNoRegex.test(oPayload.vehicalDetails.vehicalNo))) {
            ...
            if (!(vehicalNoRegex.test(vehicalNo))) {
                ...
                // this.getView().byId("idMessageStrip1").setText(`please enter valid Vehicle Number`);
        ...
        unRegister: async function () {
            ...
            MessageToast.show(`${oVehicalNo} is unregistered for the requested ${this.selectedPlotNo}`)
            // this.getView().byId("idMessageStrip8").setType("Information")
        ...
        checkReservationStatus: async function (oModel, sVehicalNo, sResrved) {
            return new Promise((resolve, reject) => {
                oModel.read("/Reservation", {
                    filters: [
                        new Filter("vehicalNo", FilterOperator.EQ, sVehicalNo),
        ...
        onSearchAllocatedSlots: function (event) {
        ...
        onSearchReserved: function (event) {
            var sQuery = event.getSource().getValue();
        ...
        onSearchHistory: function (event) {
            var sQuery = event.getSource().getValue();
        ...
        onButPress1: function () {
            if (this.getView().byId("idShowFilter1").getText() === "ShowFilter") {
                this.getView().byId("searchField1").setVisible(true)
                this.getView().byId("idShowFilter1").setText("HideFilter")
            }
            else {
                this.getView().byId("searchField1").setVisible(false)
        ...
        //     if (oView.byId("idProcessType").getVisible()) {
        //         var oSelect = oView.byId("idProcessType");
        //         var oSelectedItem = oSelect.getSelectedItem();
        ...
        //                 <p><span class="label">Vehicle Type   :</span>${sSelectedText}</p>
        ...
        detaild: function () {
            if (this.ID === "Security") {
                this.getView().byId("userTitle").setText("Ravi");
                this.getView().byId("email").setText("ravi@security.com")
                this.getView().byId("phone").setText("9987566576")
                ...
                this.getView().byId("userTitle").setText("Raju");
                this.getView().byId("email").setText("raju@supervisor.com")
                this.getView().byId("phone").setText("9876456754")
                this.getView().byId("userRole").setText(`Role: ${this.ID}`)
            }
        },
        ...
        onShowOptionsPress: function () {
            // Get the container holding the additional buttons
            var oButtonContainer = this.byId("buttonContainer");

            // Toggle the visibility of the button container
            oButtonContainer.setVisible(!oButtonContainer.getVisible());
        },

        onAvailablePress: function () {
            // Handle Available button press
            sap.m.MessageToast.show("Available button pressed");
        },

        onEmptyPress: function () {
            // Handle Empty button press
            sap.m.MessageToast.show("Empty button pressed");
        },

        onAllocatedPress: function () {
            // Handle Allocated button press
            sap.m.MessageToast.show("Allocated button pressed");
        },

        onReservedPress: function () {
            // Handle Reserved button press
            sap.m.MessageToast.show("Reserved button pressed");
        },
        ...
        clear1: async function () {
            ...
            oView.byId("idProcessTypeResVendor").setValue();
